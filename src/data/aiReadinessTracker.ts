...
export const AI_READINESS_DATA: VendorAiReadiness[] = [
  ...
  {
    id: 'honeywell-sparta',
    vendorName: 'Honeywell (Sparta Systems)',
    ticker: 'NASDAQ: HON',
    productName: 'TrackWise & TrackWise Digital',
    tier: 1,
    tierLabel: 'Tier 1 — Platform Incumbent',
    category: 'Platform Incumbent',
    ...
    mcpDetails: 'Honeywell announced Forge Life Sciences AI connectivity roadmap. TrackWise Digital leverages Salesforce foundation APIs, while on-premise TrackWise remains closed.',
    apiGrade: 'Grade B (Standard REST, Rate Limited)',
    apiDetails: 'TrackWise Digital offers REST/Salesforce APIs with webhooks. Legacy on-premise TrackWise relies on web services/SOAP and batch ETL.',
    webhooksSupported: true,
    byoAiPolicy: 'Connector Add-on Required',
    iso42001Status: 'In Audit / Self-Attested',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'TrackWise is transitioning between generations: on-premise installations remain defensive legacy vaults, while TrackWise Digital on Salesforce offers more accessible endpoints. Honeywell Forge aims to unify shop-floor telemetry with quality records.',
  ...
  },
  {
    ...
    mcpStatus: 'None / Refusal',
    mcpDetails: 'No announced MCP support. AI development is focused internally on Hexagon Manufacturing Intelligence digital reality and sensor-driven quality workflows.',
    apiGrade: 'Grade B (Standard REST, Rate Limited)',
    apiDetails: 'ETQ Reliance Integration Management module exposes REST endpoints, but requires dedicated middleware packages and lacks native streaming agentic webhooks.',
  ...
  },
  {
    ...
    category: 'Platform Incumbent',
    walledGardenStatus: 'Selective / Conditional',
    openReadinessScore: 56,
    mcpStatus: 'Proprietary Alternative Only',
    mcpDetails: 'No public MCP server. PTC deployed Arena Connect (low-code connector layer) and an AWS Bedrock-powered AI Engine in release 2026.2, offering proprietary AI Assistants for ECO and CAPA workflows rather than open agent protocols.',
    apiGrade: 'Grade B (Standard REST, Rate Limited)',
    apiDetails: 'Arena Connect integration layer introduced in 2026.2 provides pre-built templates and visual connectors for ERP/MES, augmenting core REST APIs with modernized event routing.',
    webhooksSupported: true,
    byoAiPolicy: 'Connector Add-on Required',
    iso42001Status: 'Uncertified / None',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Arena modernized its integration posture in 2026 with Arena Connect and Bedrock-backed AI capabilities. While still lacking open MCP support, low-code connectors and automated BOM compliance checks significantly ease integration overhead for discrete MedTech devices.',
    commercialMoatRisk: 'Medium (Conditional Access)',
    apiPricingPosture: 'Tiered / Usage Surcharges',
    lastAudited: 'September 2026',
  ...
  // ==========================================
  {
    ...
    mcpStatus: 'GA (Shipped)',
    mcpDetails: 'Shipped production Model Context Protocol (MCP) Server for GG Quality. Allows external AI agents (Claude, ChatGPT, Microsoft Copilot) to directly query CAPAs, nonconformances, and design matrices using standardized MCP tools with 21 CFR Part 11 audit trails.',
    apiGrade: 'Grade A (Modern REST/GraphQL + Webhooks)',
    ...
    iso42001Status: 'Certified',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Greenlight Guru has established the premier open AI posture for MedTech. By pairing accredited ISO/IEC 42001 certification with a production MCP Server and BYO-AI connector, it actively counters legacy walled-garden lock-in.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
  ...
  },
  {
    ...
    iso42001Status: 'Certified',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Qualio combines accredited ISO/IEC 42001 AI governance certification with an auditable Pydantic AI agent architecture enforcing 300+ evaluation gates per release. Its Compliance Intelligence platform and open API architecture make it a prime challenger to legacy incumbents.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
  ...
  },
  {
    ...
    iso42001Status: 'Certified',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Benefiting from the open developer foundation of Salesforce, Dot Compliance achieved accredited ISO/IEC 42001 certification and offers strong APIs. However, its commercial model heavily pushes in-house Dottie AI Personas over external agent routing.',
    commercialMoatRisk: 'Medium (Conditional Access)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
  ...
  },
  {
    ...
    mcpStatus: 'None / Refusal',
    mcpDetails: 'Relying on Salesforce Einstein 1 Studio, Agentforce, and native Agentic AI (Summer \'26 release) rather than standalone MCP server development.',
    apiGrade: 'Grade A (Modern REST/GraphQL + Webhooks)',
    ...
    iso42001Status: 'SOC 2 AI Trust Only',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Data is accessible via Salesforce standard endpoints, but advanced AI agent orchestration is channeled through Salesforce Einstein and native CQ.AI agents rather than an open protocol standard.',
    commercialMoatRisk: 'Medium (Conditional Access)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
  ...
  },
  {
    id: 'kivo',
    vendorName: 'Kivo',
    productName: 'Kivo Unified GxP Platform',
    tier: 2,
    tierLabel: 'Tier 2 — Pure-Play QMS',
    category: 'Pure-Play QMS',
    walledGardenStatus: 'Open Ecosystem',
    ...
    mcpStatus: 'In Beta / Preview',
    mcpDetails: 'Launched Headless GxP™ agent-native architecture; beta support for agentic document extraction and cross-module reference checking between clinical TMF, regulatory dossiers, and QMS SOPs.',
    apiGrade: 'Grade A (Modern REST/GraphQL + Webhooks)',
    apiDetails: 'Modern cloud-native REST APIs with Headless GxP permissioned data layer and comprehensive webhook triggers for document state transitions and signature capture.',
    webhooksSupported: true,
    byoAiPolicy: 'Full BYO-AI Allowed',
    iso42001Status: 'Uncertified / None',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'A fast-growing, agile unified platform for emerging biotech. The Headless GxP™ architecture and open API posture provide a permissioned data layer for autonomous agents across Quality, Clinical, and Regulatory without proprietary lock-in.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
  ...
  // ==========================================
  {
    id: 'ketryx',
    vendorName: 'Ketryx',
    productName: 'Ketryx Connected Lifecycle & QMS/ALM',
    tier: 4,
    tierLabel: 'Tier 4 — Disruptor / AI-Native',
    category: 'Disruptor / AI-Native',
    walledGardenStatus: 'Open Ecosystem',
    openReadinessScore: 94,
    mcpStatus: 'GA (Shipped)',
    mcpDetails: 'Shipped native MCP and agentic integrations for developer tooling in 2026. Allows autonomous AI agents to parse Jira issues, GitHub pull requests, and automated testing logs to construct dynamic 21 CFR Part 11 and IEC 62304 traceability.',
    apiGrade: 'Grade A (Modern REST/GraphQL + Webhooks)',
    apiDetails: 'Fully event-driven webhook architecture connecting bidirectional sync between engineering repositories and compliance matrices.',
    webhooksSupported: true,
    byoAiPolicy: 'Full BYO-AI Allowed',
    iso42001Status: 'SOC 2 AI Trust Only',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'The gold standard for modern developer-centric MedTech compliance. With $55M in funding and production-validated AI agents, Ketryx provides complete audit trails and automated DHF updates without proprietary model lock-in.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
