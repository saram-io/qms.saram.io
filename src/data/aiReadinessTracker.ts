...
export const AI_READINESS_DATA: VendorAiReadiness[] = [
  ...
  },
  {
    ...
    openReadinessScore: 78,
    mcpStatus: 'In Beta / Preview',
    mcpDetails: 'Beta support for agentic document extraction and cross-module reference checking between clinical TMF, regulatory dossiers, and QMS SOPs.',
    apiGrade: 'Grade A (Modern REST/GraphQL + Webhooks)',
    apiDetails: 'Modern cloud-native REST APIs with comprehensive webhook triggers for document state transitions and signature capture.',
    webhooksSupported: true,
    byoAiPolicy: 'Full BYO-AI Allowed',
    iso42001Status: 'Uncertified / None',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'A fast-growing, agile unified platform for emerging biotech. Modern API architecture and transparent document access prevent vendor lock-in for startups preparing for IND/Phase II clinical trials.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'July 2026',
