...
export const AI_READINESS_DATA: VendorAiReadiness[] = [
  ...
  },
  {
    ...
    iso42001Status: 'Certified',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'Qualio combines accredited ISO/IEC 42001 AI governance certification with aggressive agentic compliance positioning. Its Compliance Intelligence platform and open API architecture make it a prime challenger to legacy incumbents.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'September 2026',
