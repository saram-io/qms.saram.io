...
export const AI_READINESS_DATA: VendorAiReadiness[] = [
  ...
  // ==========================================
  {
    ...
    iso42001Status: 'SOC 2 AI Trust Only',
    part11AuditTrailDefensibility: 'Native Audit Log of AI Calls',
    verdictSummary: 'The gold standard for modern developer-centric MedTech compliance. By treating engineering artifacts (Git commits, PRs, Jira tickets) as live data feeds, Ketryx provides complete audit trails and automated DHF updates without proprietary model lock-in.',
    commercialMoatRisk: 'Low (Open Protocols)',
    apiPricingPosture: 'Included in Base License',
    lastAudited: 'August 2026',
