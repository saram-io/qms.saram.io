...
export const VENDORS: Vendor[] = [
  ...
  // ==========================================
  {
    ...
    aiMilestones: 'AI Agents in GA; Vault MCP Server shipped Aug 2026; Release 26R2.2 in production; launched Falcon Safety and Falcon Router in Sept 2026; secured 14 of top-20 biopharma on unified Vault platform.',
  ...
  },
  {
    ...
    aiMilestones: 'ISO/IEC 42001 certified in July 2025; launched SOP Analyzer with RAG gap detection and Event Summarizer in Quality Excellence (Qx); unified Asset Excellence (Ax) calibration in 2026.',
