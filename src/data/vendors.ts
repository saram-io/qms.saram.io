...
export const VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    summary: 'A unified cloud platform purpose-built for emerging and mid-sized biopharma. Combines document management, QMS (SOPs, CAPA, Deviations, Training), RIM, and eTMF into a single cohesive data model without cross-module sync overhead.',
  ...
  // ==========================================
  {
    ...
    summary: 'An AI-native connected lifecycle management and compliance platform purpose-built for medical devices and software-as-a-medical-device (SaMD). Natively orchestrates developer tools (Jira, GitHub, GitLab) to enforce real-time compliance with FDA QMSR, IEC 62304, ISO 13485, and ISO 14971 while automating DHF and cyber-traceability.',
