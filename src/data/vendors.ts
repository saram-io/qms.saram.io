...
export const VENDORS: Vendor[] = [
  ...
  // ==========================================
  {
    ...
    aiMilestones: 'AI Agents in GA; Vault MCP Server shipped Aug 2026; Release 26R2.2 in production; launched Falcon Safety and Falcon Router in Sept 2026 to automate multi-vendor pharmacovigilance and complaint triage into Vault QMS.',
