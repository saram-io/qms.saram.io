...
export const VENDORS: Vendor[] = [
  ...
  // ==========================================
  {
    ...
    aiMilestones: 'AI Agents in GA; Vault MCP Server shipped Aug 2026; Release 26R2.2 in production; launched Falcon Safety, Falcon Router, and Study Builder Agent in Sept 2026; Oxford Biomedica standardized multi-site viral vector QMS on Vault.',
  ...
  },
  {
    ...
    aiMilestones: 'ISO/IEC 42001 certified in July 2025; launched SOP Analyzer with RAG gap detection and Event Summarizer in Quality Excellence (Qx); published 2026 Regulatory Playbook for FDA QMSR Clause 7.1 risk enforcement.',
  ...
  {
    id: 'hexagon-etq',
    name: 'Octave (ETQ Reliance)',
    ticker: 'STO: HEXA-B',
    parentCompany: 'Hexagon AB / Octave Intelligence plc',
    product: 'Octave Reliance (ETQ Reliance)',
    tier: 1,
    tierLabel: 'Tier 1 — Platform Incumbents',
    category: 'Platform Incumbent',
    targetBuyers: ['Big-pharma', 'Supplements/food', 'Industrial & Process Manufacturing', 'Med device'],
    summary: 'Spun out and rebranded under Octave Intelligence plc (Hexagon software spin-off). An industry heavyweight in high-throughput process manufacturing, life sciences, and food & beverage with over 40 configurable quality applications. Ranked a Leader in the 2026 Nucleus Research QMS Value Matrix.',
    scope: ['Document Control', 'CAPA & Non-Conformance', 'Audits', 'Connected Plant Quality', 'EHS', 'Supplier Quality'],
    aiMilestones: 'Launched Reliance AI™ (Form Field Advisor and Complaint & Feedback Advisor); designated a Leader in the Nucleus Research QMS Technology Value Matrix 2026; launched Reliance Advanced Manufacturing Package.',
    aiReadiness: 'Moderate (AI Agents/Personas)',
    priceTransparency: 'Low (Opaque)',
    ...
    keyDifferentiator: 'Broadest pre-built application library (40+ modules) combined with Octave/Hexagon industrial metrology and sensor-to-quality connectivity.',
  ...
  },
  {
    ...
    aiMilestones: 'Released Arena 2026.2 introducing Arena Connect low-code integration pipelines and Amazon Bedrock-powered Arena AI Engine for automated BOM compliance checks, document comparisons, and conversational ECO/CAPA workflows.',
    aiReadiness: 'Moderate (AI Agents/Personas)',
    priceTransparency: 'Moderate (Directional)',
  ...
  // ==========================================
  {
    ...
    aiMilestones: 'Shipped production Model Context Protocol (MCP) Server and AI Connector for Claude, ChatGPT, and Copilot; launched automated design control synchronization from Jira; achieved accredited ISO/IEC 42001 certification.',
    aiReadiness: 'High (Agentic & MCP)',
    priceTransparency: 'Moderate (Directional)',
  ...
  },
  {
    ...
    aiMilestones: 'Achieved accredited ISO/IEC 42001 certification; deployed production Pydantic AI agent architecture with 300+ automated regression evals; powers Compliance Intelligence platform for continuous FDA QMSR audit readiness.',
    aiReadiness: 'High (ISO 42001 Certified)',
    priceTransparency: 'Moderate (Directional)',
  ...
  },
  {
    ...
    aiMilestones: 'Launched Ideagen Mazlan agentic compliance platform; deployed AI workflow generation reducing setup cycles up to 50%; named Verdantix Leader for operational AI integration.',
    aiReadiness: 'Moderate (AI Agents/Personas)',
    priceTransparency: 'Moderate (Directional)',
  ...
  },
  {
    ...
    aiMilestones: 'Structured quality data APIs enabling LLM ingestion; selected by AI-augmented biometrics CRO Acrosian in Sept 2026 to anchor GxP quality infrastructure.',
